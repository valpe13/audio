...
if exist ".venv-silero\Scripts\python.exe" (
  ".venv-silero\Scripts\python.exe" silero_tts_api\generate_silero_ru.py --text-file silero_tts_api\sample_ru_soft_female_30s.txt --output silero_tts_api\outputs\silero_ru_30s_realistic_sleep_safe_baya.wav --speaker baya --sample-rate 48000 --device cpu --realism-enabled --preset sleep_safe --pause-scale 0.82 --breath-amount 0.0 --room-tone on --loudness-variation 0.18 --seed 42
) else (
