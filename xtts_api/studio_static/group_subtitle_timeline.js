...
(function registerGroupSubtitleTimeline(namespace) {
  ...
  const DEFAULTS = { position: "bottom", font_family: "Arial", font_size: 100, color: "#ffffff", background: "#000000", background_opacity: 0, outline: 2, max_words: 5, word_offset_sec: 0 };
