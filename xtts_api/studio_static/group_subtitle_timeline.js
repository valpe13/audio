...
(function registerGroupSubtitleTimeline(namespace) {
  ...
  namespace.GroupSubtitleTimeline = { defaults, normalizeBlock, blockFromGroup, blocksFromChunks, blocksFromRows, progressiveText, progressiveBlocks, appendRow, render, bind, laneHtml, timelineHtml };
})(window.XTTSStudio);
