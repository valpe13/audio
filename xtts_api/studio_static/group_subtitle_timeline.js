...
(function registerGroupSubtitleTimeline(namespace) {
  ...
  function normalizeStyle(raw = {}) {
    ...
    return { ...raw, background_opacity: opacity };
  }
  ...
  namespace.GroupSubtitleTimeline = { defaults, normalizeBlock, blockFromGroup, blocksFromChunks, blocksFromRows, appendRow, render, bind, laneHtml, timelineHtml };
})(window.XTTSStudio);
